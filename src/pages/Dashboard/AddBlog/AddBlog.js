...
const AddBlog = () => {
    ...
    const handlePostBlog = e => {
        ...
        e.preventDefault();
        const data = { name, location, day, writer: writerName, writerImg: writerImage, desc1: description, facility, accommodation, date, price, category, status: 'pending', blogImg: image, rating };

        fetch('https://agile-dusk-49935.herokuapp.com/postBlog', {
            method: "POST",
            headers: {
